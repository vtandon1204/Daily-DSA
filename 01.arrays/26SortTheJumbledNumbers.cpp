...
// The mapped value of an integer is the new integer obtained by replacing each occurrence of digit i in the integer with
...
vector<int> sortJumbled(vector<int> &mapping, vector<int> &nums)
{
    ...
    for (int num : nums)
    {
        ...
        {
            number_mapping[num] = convert(num, mapping);
        }
    }
